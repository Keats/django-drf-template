...
# sphinx-quickstart on Wed May  7 19:14:51 2014.
#
...
texinfo_documents = [
  ('index', 'project_name', u'{{ project_name }} Documentation',
   u'Ann Onymous', 'project_name', 'One line description of project.',
   'Miscellaneous'),
]
